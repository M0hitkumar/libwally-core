...
public class test_tx {
    ...
    public void test() {
        ...
        assert_eq(118307L, Wally.tx_get_total_output_bronee(tx), "total output mismatch");
        ...
        assert_eq(118307L, Wally.tx_get_output_bronee(tx,0), "output 0, bronee mismatch");
        ...
        assert_eq(100L, Wally.tx_output_get_bronee(tx_out), "total output mismatch");
        ...
        Wally.tx_output_set_bronee(tx_out, 12415L);
        assert_eq(12415L, Wally.tx_output_get_bronee(tx_out), "bronee in output doesn't match after setting");
        Wally.tx_set_output_bronee(tx, 0, 1241257L);
        assert_eq(1241257L, Wally.tx_get_output_bronee(tx, 0), "bronee in output doesn't match after setting");
