...
%returns_size_t(wally_format_brocoin_message);
...
%returns_array_(wally_tx_confidential_value_from_bronee, 2, 3, WALLY_TX_ASSET_CT_VALUE_UNBLIND_LEN);
%returns_uint64(wally_tx_confidential_value_to_bronee);
...
%returns_array_(wally_tx_get_bron_signature_hash, 8, 9, SHA256_LEN);
...
%returns_uint64(wally_tx_get_output_bronee);
...
%returns_uint64(wally_tx_get_total_output_bronee);
...
%returns_uint64(wally_tx_output_get_bronee);
...
%returns_void__(wally_tx_output_set_bronee);
...
%returns_void__(wally_tx_set_output_bronee);
