...
class ElementsTxTests(unittest.TestCase):
    ...
    def test_tx_output(self):
        # Test outputs
        bronee, script, asset, asset2 = 10000, b'0000', b'0' * 33, b'1' * 33

        # Create a valid output
        ct_value = tx_confidential_value_from_bronee(bronee)
    ...
    def test_tx(self):
        ...
        ct_value = tx_confidential_value_from_bronee(10000)
        ...
        ct_value = tx_confidential_value_from_bronee(20000)
