...
# start-add_fee
BROCOIN = "5ac9f65c0efcc4775e0baec4ec03abdde22473cd3cf33c0419ca290e0751b225"
BROCOIN = wally.hex_to_bytes(BROCOIN)[::-1]

wally.tx_add_elements_raw_output(
    output_tx,
    None,
    bytearray([0x01]) + BROCOIN,
    wally.tx_confidential_value_from_bronee(fee),
    None, # nonce
