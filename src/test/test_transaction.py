...
class TransactionTests(unittest.TestCase):
    ...
    def test_outputs(self):
        ...
        for args in [
            ...
            (wally_tx(), MAX_BRONEE+1, script, script_len, 0), # Invalid amount
            (self.tx_deserialize_hex(TX_HEX), MAX_BRONEE, script, script_len, 0), # Invalid total amount
            ...
            # wally_tx_get_total_output_bronee
    ...
    def test_get_signature_hash(self):
        ...
        for args in [
            ...
            (tx, 0, script, script_len, MAX_BRONEE+1, 1, 1, out, out_len), # Invalid amount (only with segwit)
            ...
            self.assertEqual(WALLY_EINVAL, wally_tx_get_bron_signature_hash(*args))
        ...
        for args, expected in [
           ...
           ((tx, 0, script, script_len, 0, 1, 1, out, out_len),
            ...
            self.assertEqual(WALLY_OK, wally_tx_get_bron_signature_hash(*args))
