...
for f in (
    ...
    ('wally_format_brocoin_message', c_int, [c_void_p, c_ulong, c_uint, c_void_p, c_ulong, c_ulong_p]),
    ...
    ('wally_tx_confidential_value_from_bronee', c_int, [c_uint64, c_void_p, c_ulong]),
    ('wally_tx_confidential_value_to_bronee', c_int, [c_void_p, c_ulong, c_uint64_p]),
    ...
    ('wally_tx_get_bron_signature_hash', c_int, [POINTER(wally_tx), c_ulong, c_void_p, c_ulong, c_uint64, c_uint, c_uint, c_void_p, c_ulong]),
    ...
    ('wally_tx_get_total_output_bronee', c_int, [POINTER(wally_tx), c_uint64_p]),
