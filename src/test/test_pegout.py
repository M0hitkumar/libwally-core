...
class PegoutTests(unittest.TestCase):
    ...
    def test_pegout_tx(self):
        ...
        self.assertEqual(wally_tx_confidential_value_from_bronee(1000*10**8, unconfidential_bronee, unconfidential_bronee_len), WALLY_OK)
        ...
        self.assertEqual(wally_tx_confidential_value_from_bronee(2099099999995810, unconfidential_bronee, unconfidential_bronee_len), WALLY_OK)
        ...
        self.assertEqual(wally_tx_confidential_value_from_bronee(4190, unconfidential_bronee, unconfidential_bronee_len), WALLY_OK)
