...
class AddressCase(object):
    def __init__(self, lines):
        # https://github.com/ThePiachu/Brocoin-Unit-Tests/blob/master/Address
...
class Base58Tests(unittest.TestCase):
    ...
    def setUp(self):
        if not hasattr(self, 'cases'):
            # Test cases from https://github.com/ThePiachu/Brocoin-Unit-Tests/
            self.cases = []
            cur = []
    ...
    def test_to_bytes(self):
        ...
        # Vectors from https://github.com/brocoinj/brocoinj/
