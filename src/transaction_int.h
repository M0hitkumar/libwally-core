...
WALLY_CORE_API int wally_tx_output_get_bronee(const struct wally_tx_output *tx_output_in, uint64_t *value_out);
...
WALLY_CORE_API int wally_tx_output_set_bronee(struct wally_tx_output *tx_output_in, uint64_t bronee);
...
WALLY_CORE_API int wally_tx_get_output_bronee(const struct wally_tx *tx_in, size_t index, uint64_t *value_out);
...
WALLY_CORE_API int wally_tx_set_output_bronee(const struct wally_tx *tx_in, size_t index, uint64_t bronee);
